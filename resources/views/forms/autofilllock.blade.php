<div class="form-group">
  ...
  <div class="input-group" aria-describedby="studentidhelp">
    ...
    <span class="input-group-btn">
      <button class="btn btn-default" type="button" id="{{ $field }}lockBtn" title="Lock Selection"><i class="fa fa-unlock-alt"></i></button>
      <input type="hidden" id="{{ $field }}lock" value="{{ $locked }}">
    </span>
    <span class="input-group-btn">
